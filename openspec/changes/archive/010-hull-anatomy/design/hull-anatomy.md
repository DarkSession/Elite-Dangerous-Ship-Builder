...
(`openspec/changes/archive/002-module-outfitting/design/outfitting-workspace.md`, "Narrow and 400%-zoom composition").
...
- A dashboard mode is the other case, and it is not bounded at all. Its height is whatever the build
  ...
  column outside releases to carry it (`openspec/changes/archive/002-module-outfitting/design/outfitting-workspace.md`,
...
(`openspec/changes/archive/003-ship-statistics/design/status-capability.md`).
