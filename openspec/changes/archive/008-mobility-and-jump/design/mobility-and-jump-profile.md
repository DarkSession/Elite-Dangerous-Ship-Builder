...
2026-08-31 (`openspec/specs/ship-builder/build-status/spec.md`, FR-023); nothing about these three moves with them.
...
grid (`openspec/changes/archive/003-ship-statistics/design/status-rail.md`, item 4).
...
(`openspec/changes/archive/005-power-and-heat/design/power-and-heat-detail.md`). The projection is synchronous over a
