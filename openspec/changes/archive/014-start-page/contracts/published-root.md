...
**Feature**: [014-start-page](../../../../specs/platform/tool-navigation/spec.md) | **Owners**: `src/index.html`,
...
- **P5** — `src/index.html`'s committed head is **bound to the keys the root address
  ...
  (`openspec/changes/archive/011-interface-foundations/design/search-visibility.md`, "The product title").
...
| P5         | `e2e/search-visibility.spec.ts` against each key, plus `what a published document is titled` in `document-title.spec.ts` |
