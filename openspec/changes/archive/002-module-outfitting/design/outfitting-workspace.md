...
- **The style ceiling is 11kB. Ruled 2026-08-30.** `angular.json` sets a
  ...
  out rather than to raise the number (`openspec/changes/archive/005-power-and-heat/design/power-and-heat-detail.md`).
...
screen (Commander request 2026-08-26; `openspec/specs/ship-builder/cost-and-materials/spec.md`, FR-007a).
...
closes against it (`openspec/changes/archive/010-hull-anatomy/design/hull-anatomy.md`, "The region closes against a
...
(`openspec/changes/archive/005-power-and-heat/design/power-and-heat-detail.md`, "The compact strip's power badge").
...
not otherwise (`openspec/specs/ship-builder/power-and-heat/spec.md`, FR-014) — and where it is absent the six take the
whole strip.
...
worked (`openspec/specs/ship-builder/build-status/spec.md`, FR-024).
...
one the second plate already opens at (`openspec/specs/ship-builder/hull-anatomy`).
