...
`openspec/changes/archive/010-hull-anatomy/design/hull-anatomy.md`, "Intermediate tablet").
...
(`openspec/changes/archive/001-ship-selection-and-loading/design/hull-catalogue.md`, "Resting reads a hull only where
...
- Medium: a two-pane manifest and detail only where the collection fits beside the detail. The
  ...
  `openspec/changes/archive/001-ship-selection-and-loading/design/hull-detail.md`, "Every width below the rail's is the
