...
(`openspec/changes/archive/010-hull-anatomy/design/hull-anatomy.md`). The plates stay, the power layer is drawn over
...
(`openspec/changes/archive/002-module-outfitting/design/outfitting-workspace.md`, "a detail panel is not bounded by the
