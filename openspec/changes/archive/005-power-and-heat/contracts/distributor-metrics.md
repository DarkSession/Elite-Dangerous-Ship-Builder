...
ruling reaches it: see `openspec/changes/archive/007-offence-profile/contracts/capacitor-endurance.md`
and `openspec/specs/ship-builder/offence-profile/spec.md`, FR-006. The two blocks state one
