...
Required by T064: walk `quickstart.md` sections 1 through 8 against the built
...
[FR-007](../../../../specs/platform/help-and-licences/spec.md) and the [distribution contract](../contracts/distribution-artifacts.md).
