...
`openspec/changes/archive/005-power-and-heat/design/power-and-heat-detail.md`).
...
(`openspec/changes/archive/002-module-outfitting/design/outfitting-workspace.md`, "The compact key figures").
