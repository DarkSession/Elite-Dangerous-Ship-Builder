...
[004](../../../../specs/ship-builder/slef-exchange/spec.md), drawn in this rail, and the rail's own order is what places it. Nothing depends on hover, and the document never scrolls horizontally.
