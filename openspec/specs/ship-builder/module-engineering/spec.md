...
Blueprint and effect identities MUST use package `fdname` values.
...
Availability, modified attributes and restrictions on further engineering MUST come from the
package.
