...
| ---- | --- | -------- | -------- | ----- | -------- | ------------- | ---- | ------------------------- | ------ | ------- |
| —    | —   | Firefox  | NVDA     | —     | —        | desktop       | 1–12 | As stated in the protocol | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | mobile        | 1–12 | As stated in the protocol | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | tablet        | 1–12 | As stated in the protocol | —      | not run |
