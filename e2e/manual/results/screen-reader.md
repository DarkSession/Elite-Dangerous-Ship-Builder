...
| —    | —   | Chromium | TalkBack | —     | —        | mobile        | 21   | As above                  | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | tablet        | 21   | As above                  | —      | not run |

## The Commander account (feature 020)

Step 22 covers the three layers an account adds to the shell. Each is its own
...
| ---- | --- | -------- | -------- | ----- | -------- | ------------- | ----------- | ---- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------- |
| —    | —   | Firefox  | NVDA     | —     | —        | desktop       | landscape   | 22   | account dialog     | Signed-out and signed-in states, the data-use list read before the sign-in, and the deletion question announced as a layer of its own                   | —      | not run |
| —    | —   | Firefox  | NVDA     | —     | —        | desktop       | portrait    | 22   | account dialog     | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | tablet        | landscape   | 22   | account dialog     | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | tablet        | portrait    | 22   | account dialog     | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | mobile        | landscape   | 22   | account dialog     | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | mobile        | portrait    | 22   | account dialog     | As above                                                                                                                                                | —      | not run |
| —    | —   | Firefox  | NVDA     | —     | —        | desktop       | landscape   | 22   | record conflict    | The record named, three answers as three named controls, and leaving the layer announced as answering none of them                                      | —      | not run |
| —    | —   | Firefox  | NVDA     | —     | —        | desktop       | portrait    | 22   | record conflict    | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | tablet        | landscape   | 22   | record conflict    | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | tablet        | portrait    | 22   | record conflict    | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | mobile        | landscape   | 22   | record conflict    | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | mobile        | portrait    | 22   | record conflict    | As above                                                                                                                                                | —      | not run |
| —    | —   | Firefox  | NVDA     | —     | —        | desktop       | landscape   | 22   | owned ships        | Every ship announced with its model, name and plate; the journal interval read with the list; a held or stopped refresh said in words and the list kept | —      | not run |
| —    | —   | Firefox  | NVDA     | —     | —        | desktop       | portrait    | 22   | owned ships        | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | tablet        | landscape   | 22   | owned ships        | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | tablet        | portrait    | 22   | owned ships        | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | mobile        | landscape   | 22   | owned ships        | As above                                                                                                                                                | —      | not run |
| —    | —   | Chromium | TalkBack | —     | —        | mobile        | portrait    | 22   | owned ships        | As above                                                                                                                                                | —      | not run |
