...
export const COVERAGE_LEDGER: readonly CoverageEntry[] = [
  ...
  },
  {
    ...
    assertions: [
      ...
      'a width step bounds a centred layer and is ignored where the layer fills the screen',
      'a flush body hands its padding to content that rules the layer edge to edge',
    ],
    manualRecord: 'screen-reader',
  },
  {
