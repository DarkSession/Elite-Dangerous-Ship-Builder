...
export const COVERAGE_LEDGER: readonly CoverageEntry[] = [
  ...
  },
  {
    ...
    assertions: [
      ...
      'the pair needs room in both axes: a short window draws one side and its selector, however wide it is',
    ],
    manualRecord: 'screen-reader',
  },
  {
  ...
  },
  {
    ...
    assertions: [
      ...
      'the sentence, the POWER line and the bar hold no control between them',
      ...
      'the six key figures take the whole strip on a build that draws no badge',
