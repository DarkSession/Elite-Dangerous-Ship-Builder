...
export const COVERAGE_LEDGER: readonly CoverageEntry[] = [
  ...
  },
  {
    ...
    assertions: [
      ...
      'a pointer resting on a choosable module row washes it; the fitted-here copy takes none',
  ...
  },
  {
    ...
    assertions: [
      ...
      'a pointer resting on an unchosen effect washes it, in the menu and in the cards alike',
    ],
    manualRecord: 'screen-reader',
  },
  {
