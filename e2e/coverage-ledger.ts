...
export const COVERAGE_LEDGER: readonly CoverageEntry[] = [
  ...
  },
  {
    ...
    assertions: [
      ...
      'a column a caller declares numeric is set against one right edge, heading and figures alike',
    ],
    manualRecord: null,
  },
  {
  ...
  },
  {
    ...
    assertions: [
      ...
      'every distributor figure column is set against one right edge',
  ...
  },
  {
    ...
    assertions: [
      ...
      'every figure column is set against one right edge, so a column can be read down its length',
