...
export const COVERAGE_LEDGER: readonly CoverageEntry[] = [
  ...
  },
  {
    ...
    assertions: [
      ...
      'at a doubled text size, in German and at 400% zoom, no label is painted over its figure',
  ...
  },
  {
    ...
    assertions: [
      ...
      'every name is drawn by the shared game-text primitive, disclosing untranslated text',
      'the longest canonical name the package publishes is read whole, never truncated',
  ...
  },
  {
    ...
    assertions: [
      ...
      'the SYS allocation the power dashboard is set to is the allocation the cards are read at',
