...
export const COVERAGE_LEDGER: readonly CoverageEntry[] = [
  ...
  },
  {
    ...
    assertions: [
      ...
      'the pair needs all three of its conditions: a short window, a container without the room, or a window below the wide composition each draws one side and its selector',
    ],
    manualRecord: 'screen-reader',
  },
  {
