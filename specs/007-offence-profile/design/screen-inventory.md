...
| ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ------------------------------ |
| [Offence Analysis panel](./offence-profile.md) | The canvas's `1fr 1fr` pair, with convergence full-width below                                                                                                                                              | The same three blocks stacked in the same order           | FR-001–FR-011, SC-004          |
...
| `WEAPONS` collection                           | The canvas's five columns where the block is given 26rem, each row inert; labelled cards carrying the same five fields below that, still inert (`design/canvas-contract.md`, "Canvas revision, 2026-08-25") | Labelled cards carrying the same five fields, still inert | FR-001–FR-005                  |
...
| `SHOT CONVERGENCE`                             | The gunsight plate, its shot sentences, the range control, four facts                                                                                                                                       | The same, the plate narrowing with the block              | FR-001, FR-010, FR-011         |
...
| FR-011      | The plate is hidden from assistive technology, and every shot it draws — clamped or not — is a sentence beside it.                                 |
| FR-012      | _Withdrawn._ The canvas faces an unfilled hardpoint on its own sample build and draws nothing for it (`spec.md` FR-012).                           |
