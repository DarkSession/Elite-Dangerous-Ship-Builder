...
| `SHOT CONVERGENCE`                             | The gunsight plate carrying every hardpoint the hull has, the selected one in its own ink, its shot sentences, the range control over 500–5,000 m, four facts                                                                                                                                | The same, the plate narrowing with the block              | FR-001, FR-010–FR-013          |
