...
| `WEAPONS` collection                           | The canvas's five columns, each row inert                             | Labelled cards carrying the same five fields, still inert | FR-001–FR-005                  |
...
| FR-004      | Every returned weapon is one inert row carrying its module, damage per second, piercing and falloff, with absence stated per field. |
