...
| Shot convergence       | A placed gunsight: a dot, an edge badge and a leader per armed mount, with a sentence for each | A placed hull with nothing armed: axes and rings, no marks, none of the four facts | Gunsight unpublished for the hull; a mark clipped by the field of view; the range at both ends |
