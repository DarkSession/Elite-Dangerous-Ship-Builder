...
Research used the installed `@elite-dangerous-almanac/core@0.1.3`, its public declarations and live
...
**Rationale**: Runtime probes and declarations agree. Almanac 0.1.3 returns known weapons in hull-slot
...
All feature semantics and design choices are resolved, and pinned Almanac 0.1.3 has no feature-007
