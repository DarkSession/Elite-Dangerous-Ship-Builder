...
- [x] T073 [P] Record the Hull Anatomy capability, the installed-package schematic copy and audit, the generalized located-mount power port and the out-of-scope internal-slot geometry, weapon metrics, mount direction, convergence and coordinate data in `AGENTS.md` and `README.md`
