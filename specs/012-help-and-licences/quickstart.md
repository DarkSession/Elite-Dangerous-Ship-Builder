...
- exactly the project-specific disclaimer appears, unchanged and non-empty, inside a region
  carrying `lang="en"`;
- above it, the five-line summary of what covers what — the application's code, the bundled
  Almanac, the icon files this application serves, the game data and imagery, and the typefaces —
  one line each, localised;
