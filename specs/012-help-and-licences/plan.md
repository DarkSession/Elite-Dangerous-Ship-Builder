...
`@elite-dangerous-almanac/core` 0.1.2 installed artifacts, Node standard library (`fs`, `crypto`,
...
4. No Almanac defect blocks this feature. The installed 0.1.2 manifest and legal artifacts are
