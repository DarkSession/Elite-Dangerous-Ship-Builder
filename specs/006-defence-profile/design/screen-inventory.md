...
| FR-003      | A refused shield states each package issue once, in package order; the four states a Commander reaches by outfitting read in their own language, every other diagnosis in the package's words, and all stay distinct. |
