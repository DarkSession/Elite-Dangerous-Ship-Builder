...
| `CellBankList`            | powered; mixed; multiple duplicate symbols                  | none fitted; fitted/all-unpowered zero totals         | parent pending/failure                                  | unknown draws, long names/slots, large list                            |
...
| `DefenceSourceList`       | every role, duplicate symbols, enabled/disabled/unspecified | no resolved role records                              | parent pending/failure; action absent without slot      | unresolved neighbor, long localized names, exact-slot context          |
...
| `DefenceStatusSummary`    | ready shield/armour and detail target                       | shield unavailable; no qualifications                 | provider pending/failure                                | unknown-bank-power qualification                                       |
