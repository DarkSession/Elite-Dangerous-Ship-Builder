...
| [Import Outcome](./import-outcome.md)   | `/build` workspace after accepted commit                           | Disclose every sanctioned change, unresolved identity and final validation after the input layer closes | no changes, quality completed, fixed restored/repaired, default unavailable/incomplete, unresolved/invalid, combined, dismissed, revision changed                                                                                                    |
