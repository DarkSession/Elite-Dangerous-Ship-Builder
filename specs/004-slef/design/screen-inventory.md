...
| [Import aftermath](./import-outcome.md) | Feature 002's quality-completion notice and feature 003's build-status rail, on `/build` | Disclose quality changes and the package verdict after the input layer closes — through the surfaces that already draw them; the canvas draws no feature-004 report | no changes, quality completed, invalid, combined, notice dismissed, revision changed                                                                                                                                                                 |
