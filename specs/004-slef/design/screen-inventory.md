...
| [Import Outcome](./import-outcome.md)   | `/build` workspace after accepted commit                           | Disclose quality changes and final validation after the input layer closes       | no changes, quality completed, invalid, combined, dismissed, revision changed                                                                                                                                                                        |
...
| FR-006      | Import Outcome and Export ready                              | Package-returned fixed state is modelled directly with no application provenance                                              |
...
| FR-012      | Import Outcome                                               | Quality and final validation disclosed after commit                                                                           |
| FR-013      | Import candidate/outcome; Export round-trip states           | Package model comparison after quality completion and package-populated fixed construction, plus package output normalization |
