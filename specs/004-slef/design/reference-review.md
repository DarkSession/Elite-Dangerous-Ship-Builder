...
- **The order and the opening format follow the canvas.** Canvas 1c draws SLEF JSON first and draws it
  selected. The choice stays sticky, so a Commander who moves to the link finds the link next time.
