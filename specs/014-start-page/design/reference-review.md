...
| The 880px cap on the footer text          | Withdrawn on Commander request 2026-09-06: the whole notice on one line where the band has room. The canvas caps a notice it also truncates, and any cap on the full notice leaves short centred lines in a band holding nothing else |
