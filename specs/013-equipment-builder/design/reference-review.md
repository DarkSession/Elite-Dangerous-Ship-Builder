...
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The `ARMOUR` resistance group           | One group of bars, under its own `RESISTANCES` heading. The library publishes one set of four — `SuitGrade.kinetic/thermal/plasma/explosiveResistance` — which is the canvas's `SHIELDS` bars (`r[2]`…`r[5]`); its `ARMOUR` bars are `0.2` when Damage Resistance is fitted and `0` otherwise, invented in the mock, and that modification is already folded into the published four (`readings/suit-readings.ts`). What the canvas's split is right about survives: the figures a suit resists damage by are not the shield's strength and regeneration, and under a `SHIELDS` heading they read as the shield's own (Commander request 2026-09-04). So `SHIELDS` keeps the two cells and the four bars become the second group the canvas draws, sourced rather than invented. Its static artboard draws three of them and its prototype four, which is its own account of where the group came from. |
