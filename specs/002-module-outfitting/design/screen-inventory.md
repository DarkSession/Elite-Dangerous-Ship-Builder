...
| FR-005      | Replacement owns within-family name/class-descending/rating-ascending/stock-first order and four-field AND search with no-match/clear.                                                                                                                                                                                                                |
...
| FR-012      | Engineering offers exact package menus and distinct apply, effect-only and clear outcomes, the last reached through the package's explicit no-blueprint choice rather than a separate control.                                                                                                                                                        |
...
| FR-020      | Replacement presents collapsible families keyed on the package `familyId` and named by the package's own family lookup, as the only grouping level, at every width.                                                                                                                                                                                   |
| FR-021      | Opening or rebuilding the chooser seeds exactly one open family from the fitted choice, or none when it has no available family; the toggle produces no revision and no history step.                                                                                                                                                                 |
