...
- [x] T070 [P] [US3] Implement the attribute comparison list presenting package current versus candidate values through header and definition relationships with no arrows, percentages or better-worse colour in `src/app/ui/outfitting/attribute-comparison.ts`
