...
| Status rail cells                               | `JUMP`, `SPEED` and `MASS` following `DPS` in the rail's one cell grid, each the figure a card already states                                                                                                                                                                                                                                     | The same three in the Status stack                | FR-009, SC-001                 |
