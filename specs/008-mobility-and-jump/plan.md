...
configuration. The constitution requires TypeScript strict mode

**Primary Dependencies**: Angular standalone and zoneless APIs; Angular signals; RxJS;
`@elite-dangerous-almanac/core` leaf exports; feature 001's active-build/revision and `/build`
...
The installed Almanac package supplies `standardLoadResult()`, structured powered-thruster diagnostics from
