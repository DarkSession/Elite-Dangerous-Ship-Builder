...
Research used the installed `@elite-dangerous-almanac/core@0.1.1` declaration/runtime contracts,
...
**Rationale**: Almanac 0.1.1 directly returns every distinction required by the spec. Feature 005's
...
Almanac 0.1.1 supplies all required standard-load, jump, mobility, aggregate, fitted-slot and
