...
| Route                              | Outcome                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `/`                                | The product's own address: a screen offering the tools it carries, not a redirect into one of them (feature 014); no payload                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `/ships`                           | Hull catalogue with per-tab session state and no required hull selection                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `/ships/:hull`                     | Package hull detail, addressed by the hull's name with an underscore for each space; a hull symbol is accepted and replaced by that address; an inspector at the manifest rail's width, a full-screen sheet below it; an address no hull answers to is a safe error                                                                                                                                                                                                                                                                                                                                    |
| `/outfitting` with optional `#b.…` | Active workspace; recognized fragment passes through the shared ingress pipeline                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `/equipment` with optional `#e.…`  | On-foot bench (feature 013); recognized fragment passes through the same ingress pipeline                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| _(no route)_                       | Record library: a wide modal over an inert originating screen, or a narrow full-screen layer, raised by a shell action from wherever a Commander is. It has no address of its own — the records are held on one device, so an address for them resolves to a different list for every Commander who opens it (Commander request 2026-09-04). The address in the bar stays the originating screen's, fragment included, so it is still the address to copy while the layer is up; a history entry is pushed at that same address, so back closes the layer, and dismissing returns the screen untouched |

**Every address names what it is about, not what the application calls its state.** The workspace is
`/outfitting` because outfitting is what a Commander does there, and it is the word the tool's own
subjects already use. `build` named the object being edited rather than the place, and the product
has three meanings for that word — a modelled build, a saved record, and the compiled bundle
(Commander request 2026-09-04). No address redirects to it: an unrecognised path lands on the
product's own address, which is a Commander's way to whichever tool they wanted, and a link written
against the old path carries its payload in the fragment where a Commander can still read it.

Every route above is a surface a crawler can read and a Commander can bookmark. The library is deliberately not one: what it opens — a build — has an address, and that is where opening a record lands.

Catalogue constraints and scroll are deliberately absent from route query/fragment and build state. A detail back action restores the catalogue session anchor. Build links use only the `/outfitting` fragment.
