...
- [x] T183 [P] Give the command bar's library link the hover its buttons take in `src/app/ui/components/app-frame/app-frame.scss`. A link and a button in one row reacting differently to the pointer reads as one of them being inert (Commander request 2026-08-27)
