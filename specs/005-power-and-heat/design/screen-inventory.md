...
| Key-figure power badge                           | Not drawn: the rail beside the workspace carries the whole line                   | Against the trailing edge of canvas 1d's strip of key readings, where a priority group is dark — one line naming each dark group, over the share of plant output where the plant has output           | FR-014                 |
