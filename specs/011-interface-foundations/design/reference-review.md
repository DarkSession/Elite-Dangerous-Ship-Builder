...
| The canvases’ Help · About block naming the work “Elite Dangerous Ship Builder” | The Frontier media-usage notice in `LICENSE` names Nav Beacon, which is the work; a canvas is a rendered source and is not edited to follow it | Constitution VII           |
