...
| FR-029      | Shared waiting components, the accounted wait inventory in `design/waiting-states.md`, and ledger entries for the waits an end-to-end run can hold open, scanned where the state stands long enough to sweep |
