 ...
 * on a third.
 *
 * The heading is an `h2` at every call site. Each of them draws this block as
 * the whole of a screen whose `h1` is the bar above it, so a level of its own
 * would be a second outline decision made in three places.
 *
