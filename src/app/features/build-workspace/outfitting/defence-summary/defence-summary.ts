 ...
 * features own them between them. These are this feature's two, drawn under
 * feature 005's `POWER` line and ahead of the rest, exactly where canvas 1c
 * draws them. Canvas 1d draws the same two in its Status mode.
 *
